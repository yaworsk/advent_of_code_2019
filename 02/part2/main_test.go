...
func TestMain(t *testing.T) {
	...
	wanted[4] = []int{8, 3, 5, 5, 1, 25, 6, 0, 99, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2}
	...
	input[4] = []int{2, 3, 5, 5, 1, 5, 6, 0, 99, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2}
	...
	gotNoun, gotVerb := search(input[4], 8)
	wantedNoun := 3
	wantedVerb := 5
	if wantedNoun != gotNoun && wantedVerb != gotVerb {
		t.Errorf("search = verb(%d), noun(%d); wanted verb(%d), noun(%d)",
			gotVerb, gotNoun, wantedVerb, wantedNoun)
	}
}
